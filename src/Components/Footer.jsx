...
function Footer() {
    return (
        <>
            <footer className='w-full display-none-m  bg-[#12125A] custom-m:mt-16  py-5'>
                <div className='mx-auto px-16 pt-5 px-m max-w-[1280px] '>
            ...
            {/* for Mobile */}
            <footer className='w-full bg-[#12125A] custom-m:mt-16  py-5 display-none-desktop '>

                <div className='px-m max-w-[1280px]'>
                        ...
                        <div>
                            <a href='#scrol-button-m' className='flex items-center fz-16-footer-btn gap-2'>
                                ...
                                <span className='bg-[#FFFFFF] rounded-[100%] py-2.5 px-2'>
                                    <img src={arrow} alt="" className=' w-[12px]' />
                                </span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className='flex pt-10 gap-20'>
                        ...
                        <div className='text-left  '>
                            <p className='fz-16 fz-13-m-team'>An innovative institute dedicated to emerging careers, offers transformative courses designed to equip students with cutting-edge skills and industry-relevant knowledge</p>

                            <h2 className='mt-4  fz-14-m-featured text-[#FFFFFF]' >Address</h2>

                            <p className='pt-4  fz-12-m-user text-[#FFFFFF]'>123 Main Street</p>
                            <p className=' fz-12-m-user text-[#FFFFFF]'>Gulberg III,</p>
                            <p className=' fz-12-m-user text-[#FFFFFF]'>Pakistan</p>


                            <p className='pt-4  fz-12-m-user text-[#FFFFFF]'>Email: iec@gmail.com</p>
                            <p className=' fz-12-m-user text-[#FFFFFF]'>Call: 0333-4567904</p>

                        </div>
                        <div className='max-w-[86px]  flex flex-col gap-5 fz-12-m-r'>
                            <p ><a href="">Apprentices</a></p>
                            <p><a href="">Employers</a></p>
                            <p><a href="">IEC Fellows</a></p>
                            <p><a href="">About IEC</a></p>
                ...
                <div className=' w-[full] mt-12 text-[#FFFFFF]'>
                    <h1 className='text-start fz-14-m-f'>Newsletter Subscription</h1>
                    <p className='py-3 fz-16 fz-12-m-featured'>Stay up-to-date about the impact stories of IECX graduates, new partnerships and course emnrollment process!</p>

                    <div className='pt-3'>
                        <input className='py-[13px] ps-5 w-[13rem] rounded-l-xl fz-14' type="text" name="" id="" placeholder='Enter your Email' />
                        <button className='btn py-[18px] rounded-r-lg px-7 fz-12-m-teambtn bg-[#BE1300]'>Subcribe</button>
                    </div>

                    <p className='fz-12-m-featured pt-2'>By sharing your email, you acknowledge our Privacy Policy & Terms of Services.</p>

                    <div className="mb-6 flex justify-start flex-wrap  mt-5 gap-3">
                        <div className='bg-[#FFFFFF] items-center h-9 w-8 rounded-lg flex justify-center'>
                            <a
                                href="#!"
                                type="button"
                                className="m-1 h-7 w-7 rounded-full bg-[#12125A] border-2 border-white uppercase leading-normal"
                                data-te-ripple-init
                                data-te-ripple-color="light">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className='bg-[#FFFFFF] h-9 w-8 items-center  rounded-lg flex justify-center'>
                        ...
                        <div className='bg-[#FFFFFF] h-9 w-8 items-center  rounded-lg flex justify-center'>
                            <a
                                href="#!"
                                type="button"
                                className="m-1 h-7 w-7 flex justify-center p-1 rounded-full border-2 bg-[#12125A]  uppercase leading-normal    "
                                data-te-ripple-init
                                data-te-ripple-color="light">
                                <img src={twitter} alt="" />
                            </a>
                ...
                <hr className='bg-[#FFFFFF] mt-1' />
                    <p className='fz-11-m text-[#FFFFFF] pt-5'>Ⓒ2022 iec.org.pk., All rights reserved. Terms of Use - Privacy</p>
